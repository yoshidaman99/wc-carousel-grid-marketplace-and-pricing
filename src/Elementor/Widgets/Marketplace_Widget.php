...
class Marketplace_Widget extends Widget_Base
{
    ...
    {
        ?>
        <div class="wc-cgmp-marketplace wc-cgmp-editor-preview" style="background: #f9fafb; border: 2px dashed #d1d5db; border-radius: 12px; padding: 40px; text-align: center;">
            <div style="margin-bottom: 12px;">
                <span class="eicon-products" style="font-size: 40px; color: #9ca3af;"></span>
            </div>
            <p style="margin: 0 0 4px 0; font-size: 16px; font-weight: 600; color: #374151;"><?php esc_html_e('WC Marketplace', 'wc-carousel-grid-marketplace-and-pricing'); ?></p>
            <p style="margin: 0; font-size: 13px; color: #9ca3af;"><?php esc_html_e('Preview available on the frontend.', 'wc-carousel-grid-marketplace-and-pricing'); ?></p>
        </div>
        <?php
    }
